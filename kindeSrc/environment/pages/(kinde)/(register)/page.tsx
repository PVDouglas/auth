...
/**
 * Rota.Website — Kinde custom UI (register).
      ...
      <body className="rota-auth-bg">
        <main className="auth-shell">
          ...
          <div className="auth-card">
            ...
            <p className="auth-sub">Set up your Rota.Website account in a couple of steps.</p>

            <div id="kinde-widget">{getKindeWidget()}</div>

            <div className="auth-foot">Already have an account? <a href="https://rota.website/login">Sign in</a></div>
          </div>
